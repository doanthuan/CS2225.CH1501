...
class Window(Frame):
    ...
    def open_file(self):
        ...
        ret, image = cap.read()
        cv2.imwrite(PRJ_PATH + '/Images/preview.jpg', image)

        self.show_image(PRJ_PATH + '/Images/preview.jpg')
    ...
    def imgClick(self, event):
        ...
        if self.counter == 2:
            ...
            print(self.line)
            print(self.rect)
            img = cv2.imread(PRJ_PATH + '/Images/preview.jpg')
            cv2.line(img, self.line[0], self.line[1], (0, 255, 0), 3)
            cv2.imwrite(PRJ_PATH + '/Images/copy.jpg', img)
            self.show_image(PRJ_PATH + '/Images/copy.jpg')
    ...
    def main_process(self):
        ...
        fps = reader.get_meta_data()['fps']    
        writer = imageio.get_writer(PRJ_PATH + '/Resources/output/output.mp4', fps = fps)
